    ...
    <CodeWrapper>
      ...
      <div className="articeBox">
        <article className="articleContent">
          ...
          take time to create a payment gateway for each boxes and I thought
          that'a an extra work.And after making 4 projects for 4 boxes , you
          need to create QR codes for 4 of the projects codes. So for time being
          I made a common QR code, so when you scan , it will redirect you to
          deployed link, after that you can fill and complete the payment. After
          payment the payment details such as box number, amount paid,
          email,succcess message and date/time is saved in firebase backend and
          in stripe. Stripe is just a payment gateway, react can communicate
          backend with firebase, so all entered details are saved over there in
          a collection named "machinePaymentsSuccess"
        </article>
      </div>
